...
`r Biocannopkg("TxDb.Hsapiens.UCSC.hg38.knownGene")` package to identify
genomic coordinates, we want to use the a genome package that is based on the same refernece genome, namely `r Biocannopkg("BSgenome.Hsapiens.NCBI.GRCh38")`.
